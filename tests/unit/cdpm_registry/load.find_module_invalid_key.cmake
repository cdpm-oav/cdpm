...
set(tmp "${CMAKE_CURRENT_LIST_DIR}/.tmp/find_module_invalid_key")
file(REMOVE_RECURSE "${tmp}")
file(MAKE_DIRECTORY "${tmp}/packages/demo")
file(WRITE "${tmp}/packages/demo/package.json"
    [[{"find_package_name":"Demo","find_module":{"bad-name":"lib/cmake"},
...
message(FATAL_ERROR "FAIL: invalid find_module key was accepted")
