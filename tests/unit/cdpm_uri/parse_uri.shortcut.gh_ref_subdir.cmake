# Test: parse_uri.shortcut.gh_ref_subdir
include("${CMAKE_SOURCE_DIR}/core/cdpm_uri.cmake")
include("${CMAKE_SOURCE_DIR}/tests/helpers.cmake")

cdpm_parse_uri("gh:cdpm-oav/cdpm@1.2.3#include" PREFIX dep)
...
assert_eq("${dep_SUBDIR}"        "include"                               "subdir")
message(STATUS "PASS: gh: shortcut with @ref and #subdir")
