...
set(tmp "${CMAKE_CURRENT_LIST_DIR}/.tmp/hints_applied")
...
assert_eq("${val}" "${tmp}/install/lib/cmake" "find_module hint is applied from the install prefix")

file(REMOVE_RECURSE "${tmp}")
message(STATUS "PASS: find_module hints are applied from the install prefix")
