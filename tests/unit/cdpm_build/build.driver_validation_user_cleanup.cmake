...
foreach(case IN ITEMS unknown missing invalid make)
    execute_process(
    ...
    elseif(case STREQUAL "invalid")
        ...
        set(expected "driver 'make' is not yet implemented")
    endif()
    ...
    if(case STREQUAL "make" AND NOT EXISTS "${tmp}/${case}/runtime/user")
