...
function(_cdpm_autotools_configure_args ctx_json out_args)
    ...
    if(NOT e_options)
        ...
        foreach(key IN LISTS option_keys)
            _cdpm_json_get(val "${options}" PATH "${key}" OUT_TYPE val_type)
            if(key MATCHES [[^--]])
...
function(cdpm_bs_autotools_build ctx_json)
    ...
    block(SCOPE_FOR VARIABLES)
        ...
        foreach(member toolchain execution_path program_path build_type prefix_path module_path user_file archive_cache_dir)
